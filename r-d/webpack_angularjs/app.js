...
var ProductComponent_1 = __webpack_require__(93);
var AppModule = (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [ProductComponent_1.ProductComponent],
            bootstrap: [ProductComponent_1.ProductComponent]
        })
    ], AppModule);
    return AppModule;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_observable_forkJoin__ = __webpack_require__(57);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_observable_fromPromise__ = __webpack_require__(38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_operator_map__ = __webpack_require__(20);
...
function toObservable(r) {
    var /** @type {?} */ obs = __WEBPACK_IMPORTED_MODULE_1__angular_core__["ɵisPromise"](r) ? __WEBPACK_IMPORTED_MODULE_3_rxjs_observable_fromPromise__["fromPromise"](r) : r;
    if (!(__WEBPACK_IMPORTED_MODULE_1__angular_core__["ɵisObservable"](obs))) {
...
var CHECKBOX_VALUE_ACCESSOR = {
    ...
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return CheckboxControlValueAccessor; }),
    multi: true,
};
/**
...
var DEFAULT_VALUE_ACCESSOR = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return DefaultValueAccessor; }),
    multi: true
};
/**
 ...
 */
function _isAndroid() {
    var /** @type {?} */ userAgent = __WEBPACK_IMPORTED_MODULE_5__angular_platform_browser__["ɵgetDOM"]() ? __WEBPACK_IMPORTED_MODULE_5__angular_platform_browser__["ɵgetDOM"]().getUserAgent() : '';
...
var NUMBER_VALUE_ACCESSOR = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return NumberValueAccessor; }),
    multi: true
};
/**
...
var RADIO_VALUE_ACCESSOR = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return RadioControlValueAccessor; }),
    multi: true
};
/**
...
var RANGE_VALUE_ACCESSOR = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return RangeValueAccessor; }),
    multi: true
};
/**
...
var SELECT_VALUE_ACCESSOR = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return SelectControlValueAccessor; }),
    multi: true
};
/**
 * @param {?} id
...
var SELECT_MULTIPLE_VALUE_ACCESSOR = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return SelectMultipleControlValueAccessor; }),
    multi: true
};
/**
 * @param {?} id
...
function isPropertyUpdated(changes, viewModel) {
    ...
    if (change.isFirstChange())
        return true;
    return !__WEBPACK_IMPORTED_MODULE_1__angular_core__["ɵlooseIdentical"](viewModel, change.currentValue);
}
...
var formDirectiveProvider = {
    ...
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return NgForm; })
};
...
var modelGroupProvider = {
    provide: ControlContainer,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return NgModelGroup; })
};
/**
...
var formControlBinding = {
    provide: NgControl,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return NgModel; })
};
/**
...
var formControlBinding$1 = {
    provide: NgControl,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return FormControlDirective; })
};
/**
...
var formDirectiveProvider$1 = {
    provide: ControlContainer,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return FormGroupDirective; })
};
/**
...
var formGroupNameProvider = {
    provide: ControlContainer,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return FormGroupName; })
};
/**
...
var formArrayNameProvider = {
    provide: ControlContainer,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return FormArrayName; })
};
/**
...
var controlNameBinding = {
    provide: NgControl,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return FormControlName; })
};
/**
...
var REQUIRED_VALIDATOR = {
    ...
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return RequiredValidator; }),
    multi: true
};
var CHECKBOX_REQUIRED_VALIDATOR = {
    provide: NG_VALIDATORS,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return CheckboxRequiredValidator; }),
    multi: true
};
/**
...
var EMAIL_VALIDATOR = {
    provide: NG_VALIDATORS,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return EmailValidator; }),
    multi: true
};
/**
...
var MIN_LENGTH_VALIDATOR = {
    provide: NG_VALIDATORS,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return MinLengthValidator; }),
    multi: true
};
/**
...
var MAX_LENGTH_VALIDATOR = {
    provide: NG_VALIDATORS,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return MaxLengthValidator; }),
    multi: true
};
/**
...
var PATTERN_VALIDATOR = {
    provide: NG_VALIDATORS,
    useExisting: __WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"](function () { return PatternValidator; }),
    multi: true
};
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(10);
var Product_1 = __webpack_require__(94);
var ProductComponent = (function () {
    function ProductComponent() {
        this.product = new Product_1.Product(0, '', 0, '');
        this.products = new Array();
        this.products.push(new Product_1.Product(101, 'Laptop', 98000, 'IT'));
        this.products.push(new Product_1.Product(102, 'Desktop', 48000, 'IT'));
        this.products.push(new Product_1.Product(103, 'TV', 18000, 'Electronics'));
    }
